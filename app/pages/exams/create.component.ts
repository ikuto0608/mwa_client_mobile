...
@Component({
  selector: 'exams-create',
  templateUrl: 'pages/exams/create.component.html',
  styleUrls: ['pages/exams/create-common.css', 'pages/exams/create.css'],
})
